...
const EditCategoryModal = () => {
    ...
    return (
        <Box component={'form'} onSubmit={handleSubmit(onSubmit)}>
            ...
            >
                id: {categoryData?.data.category.id}
            </p>
                    ...
                    <>
                        ...
                        <Box sx={{ display: 'flex' }}>
                            <Box>
                                ...
                                <img
                                    src={categoryData?.data.category.iconImg}
                                    alt={categoryData?.data.category.category}
                                />
                            </Box>
                            <Box>
                                <p className={'modalHintImgSize'}>726 x 726</p>
                                <img
                                    src={categoryData?.data.category.mainImg}
                                    alt={categoryData?.data.category.category}
                                />
                            </Box>
                        </Box>
